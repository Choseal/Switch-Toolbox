...
namespace FirstPlugin
{
    ...
    public class ELinkFile
    {
        ...
        //  downstream offsets shift like a block append. Ported from prototypes verified against
        //  the real file (every case re-parses clean across all 1345 users).
        ...
        byte[] SerializeUser(UserBlock ub, List<CallNode> order)
        {
            ...
            int leafRank = 0;       // ACT+0x04 is the leaf's rank among the user's leaves (containers carry -1); file-verified, regenerated here
